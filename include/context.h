...
#define VERSION_STRING QUOTE_CMD(VERSION_MAJOR)"."QUOTE_CMD(VERSION_MINOR)"."QUOTE_CMD(VERSION_PATCH)"."QUOTE_CMD(VERSION_TWEAK)".dev"
#else
#define VERSION_STRING QUOTE_CMD(VERSION_MAJOR)"."QUOTE_CMD(VERSION_MINOR)"."QUOTE_CMD(VERSION_PATCH)"."QUOTE_CMD(VERSION_TWEAK)
#endif
