...
#if !defined(CONFIG_LOGGER_VERSION_MAJOR)
#define VERSION_MAJOR 1
#else
#define VERSION_MAJOR CONFIG_LOGGER_VERSION_MAJOR
#endif
#if !defined(CONFIG_LOGGER_VERSION_MINOR)
#define VERSION_MINOR 0
#else
#define VERSION_MINOR CONFIG_LOGGER_VERSION_MINOR
#endif
#if !defined(CONFIG_LOGGER_VERSION_PATCH)
#define VERSION_PATCH 4
#else
#define VERSION_PATCH CONFIG_LOGGER_VERSION_PATCH
#endif
#if !defined(CONFIG_LOGGER_VERSION_BUILD)
#define VERSION_BUILD 2
#else
#define VERSION_BUILD CONFIG_LOGGER_VERSION_BUILD
#endif

#if defined(CONFIG_LOGGER_BUILD_MODE_DEV)
#define VERSION_STRING "v"QUOTE_CMD(VERSION_MAJOR)"."QUOTE_CMD(VERSION_MINOR)"."QUOTE_CMD(VERSION_PATCH)"."QUOTE_CMD(VERSION_BUILD)".dev"
#else
#define VERSION_STRING "v"QUOTE_CMD(VERSION_MAJOR)"."QUOTE_CMD(VERSION_MINOR)"."QUOTE_CMD(VERSION_PATCH)"."QUOTE_CMD(VERSION_BUILD)
#endif
